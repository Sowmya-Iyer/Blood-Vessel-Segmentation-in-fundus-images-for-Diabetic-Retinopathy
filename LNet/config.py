...
def parse_args():
    ...
    # in/out
    parser.add_argument('--outf', default='/content/drive/MyDrive/DR/Vessel Segmentation/Net/experiments',
    ...
    parser.add_argument('--train_data_path_list',
                        default='/content/drive/MyDrive/DR/Vessel Segmentation/Net/prepare_dataset/data_path_list/DRIVE/train.txt')
    parser.add_argument('--test_data_path_list',
                        default='/content/drive/MyDrive/DR/Vessel Segmentation/Net/prepare_dataset/data_path_list/DRIVE/test.txt')
    ...
    parser.add_argument('--start_epoch', default=1, 
                        help='Start epoch')
    parser.add_argument('--pre_trained', default="UNet_vessel_seg/best_model.pth",
